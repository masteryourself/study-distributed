package pers.masteryourelf.study.mq.activemq.api.topic.persistence.conumer;
 ...
 */
public class PersistenceTopicConsumer2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 创建持久化订阅者
        TopicSubscriber consumer = session.createDurableSubscriber(destination, "9528");
