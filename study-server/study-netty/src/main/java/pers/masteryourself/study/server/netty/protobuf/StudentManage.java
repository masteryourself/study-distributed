package pers.masteryourself.study.server.netty.protobuf;// Generated by the protocol buffer compiler.  DO NOT EDIT!
// source: student.proto

public final class StudentManage {
  ...
  /**
   * <pre>
   * protobuf 使用 message 管理数据，会在 StudentManage 外部类生成一个内部类 Student， 他是真正发送的实体对象
   * </pre>
   *
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return StudentManage.internal_static_Student_descriptor;
    }

    @Override
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return StudentManage.internal_static_Student_fieldAccessorTable
    ...
    public static final class Builder extends
      ...
      // Construct using StudentManage.Student.newBuilder()
      private Builder() {
  ...
  static {
    String[] descriptorData = {
      ...
      "\n\004name\030\002 \001(\tB\017B\rStudentManageb\006proto3"
    };
